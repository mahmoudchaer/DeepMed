...
EXPERIMENT_NAME = os.getenv('MLFLOW_EXPERIMENT_NAME', 'lasso_regression_model')
...
class LassoRegressionTrainer:
    ...
    def train(self, X_train, X_test, y_train, y_test):
        """Train lasso regression model and track with MLflow"""
        logger.info("Starting lasso regression model training")
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting Lasso Regression API on port {PORT}")
