...
EXPERIMENT_NAME = os.getenv('MLFLOW_EXPERIMENT_NAME', 'svr_model')
...
class SVRTrainer:
    ...
    def train(self, X_train, X_test, y_train, y_test):
        """Train SVR model and track with MLflow"""
        logger.info("Starting SVR model training")
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting SVR API on port {PORT}")
