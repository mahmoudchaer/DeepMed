...
EXPERIMENT_NAME = os.getenv('MLFLOW_EXPERIMENT_NAME', 'linear_regression_model')
...
class LinearRegressionTrainer:
    def __init__(self, test_size=0.2):
        ...
        self.model_config = {
            ...
            'params': {
                ...
                'classifier__n_jobs': [-1]  # Use all processors
            },
    ...
    def train(self, X_train, X_test, y_train, y_test):
        """Train linear regression model and track with MLflow"""
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting Linear Regression API on port {PORT}")
